An app that displays the highest paying jobs in any city for any job title. Uses a map to help visualize where jobs are concentrated relative to a city.
